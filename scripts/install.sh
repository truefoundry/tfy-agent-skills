...
SKILL_NAMES=(
  access-control access-tokens ai-gateway applications deploy docs gitops guardrails helm jobs llm-deploy logs mcp-servers ml-repos notebooks prompts secrets service-test ssh-server status tracing volumes workflows workspaces
)
